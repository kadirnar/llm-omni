...
Literature often uses tiny attention models like xformer (?) mini-gpt etc to get output tokens and then
project to new LLM dim
"""
...
class ImageTokenizer(nn.Module):
    ...
    def forward(self, x):
        """Forward maps vision_encoder outputs to llm_token input size (bs, seq_length, in_size) -> (bs,
        seq_length, out_size)
        """
