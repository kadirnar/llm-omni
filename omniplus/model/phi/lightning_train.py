...
parser.add_argument('--gpu_ids', help='Comma-separated list of GPU Numbers to use', default='0', type=str)

parser.add_argument('--version_name', help='version name in save_dir', type=str, default='test')
...
trainer = L.Trainer(accelerator="gpu", devices=gpu_ids, gradient_clip_val=1, max_steps=60000)
